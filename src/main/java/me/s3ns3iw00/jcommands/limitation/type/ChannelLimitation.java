...
public class ChannelLimitation extends Limitation<TextChannel> {
    ...
    public ChannelLimitation(Server server, boolean permit, TextChannel entity) {
        super(server, permit);
        this.entity = entity;
    }
     ...
     * @return the instance
     */
    public static ChannelLimitation with(Server server, boolean permit, TextChannel entity) {
        return new ChannelLimitation(server, permit, entity);
    }
}
