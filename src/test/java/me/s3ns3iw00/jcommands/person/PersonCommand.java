...
/**
 * A {@link ServerCommand} that is for to manage people, and a {@link CommandActionEventListener} to be able to listen for its usage
 */
public class PersonCommand extends ServerCommand implements CommandActionEventListener {
    ...
    public PersonCommand() {
        ...
        addConcatenator(new StringConcatenator(" "), addArgument.getFirstNameArgument(), addArgument.getLastNameArgument());
